...
subprocess.run([sys.executable, "-m", "PyInstaller", "--noconfirm", "--clean",
    ...
    "--add-data", f"{root / 'conesrs/data/models/aktina.beamdata.json'};conesrs/data/models",
    "--add-data", f"{root / 'conesrs/data/models/elekta.beamdata.json'};conesrs/data/models",
